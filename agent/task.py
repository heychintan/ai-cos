...
def new_task(
    ...
    webflow_jobs_days: int = 7,
    webflow_jobs_featured_first: bool = True,
    webflow_blogs_enabled: bool = False,
    webflow_blogs_days: int = 7,
    webflow_blogs_featured_first: bool = True,
